...
public class Fractal : MonoBehaviour
{
    ...
    private static readonly float3[] _directions = {up(),left(),right(),forward(),back()};
...
quaternion.RotateX(-.5f * PI),
    ...
    private struct UpdateFractalLevelJob : IJobFor
    {
        ...
        public void Execute(int index)
        {
            ...
            mul(parent.WorldPosition, _positionOffset * Scale *
            part.Direction);
            Parts[index] = part;
    ...
    private void OnEnable()
    {
        ...
        {
            var levelParts = _parts[li]; for (var fpi = 0; fpi < levelParts.Length; fpi += _childCount)
            {
    ...
    private void Update()
    {
        ...
        var deltaRotation = quaternion.RotateZ(rootPart.SpinAngle);
        rootPart.WorldRotation = mul(rootPart.Rotation , deltaRotation);
        _parts[0][0] = rootPart;
        _matrices[0][0] = float4x4.TRS(rootPart.WorldPosition,
        ...
        for (var li = 1; li < _parts.Length; li++)
        {
            ...
            }.ScheduleParallel(_parts[li].Length,8, jobHandle);
        }
        jobHandle.Complete();
        ...
        //    var levelMatrices = _matrices[li]; for (var fpi = 0; fpi < levelParts.Length; fpi++)
        //    {
        ...
        //        part.WorldRotation = mul(parent.WorldRotation , part.Rotation) *
        //        deltaRotation;
        //        part.WorldPosition = parent.WorldPosition +
        //        mul(parent.WorldRotation , (_positionOffset
